...
#define c_DIRECTION 0   //set to '0' if tracking direction is reversed, TBD need to add support for southern hemisphere
...
#define SLEW_SPEED 250 //tweak this value if you want to increase/decrease the max slew speed, change in steps of 100
/**********************/
